  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1511537190424-bbbab87ac5eb?w=1600&h=600&fit=crop&crop=center')",
        }}
      />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          Stories from our roastery, barista tips, and the coffee culture we love.
        </p>
      </div>
    </section>
  );
